                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                            <a href="{{ route('diaries.show', $diary->id) }}" class="text-green-600 hover:text-blue-900 mb-2 mr-2" title="Exibir usuário">Ver</a>
                                                            <a href="{{ route('diaries.edit', $diary->id) }}" class="text-indigo-600 hover:text-indigo-900 mb-2 mr-2" title="Editar usuário">Editar</a>
