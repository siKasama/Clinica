@extends('layouts.app', ['activePage' => 'user.index', 'title' => 'Clinica x', 'navName' => 'Users', 'activeButton' => 'laravel'])
            ...
            <div class="col-md-12">
                <div class="card-header ">
                    <div class="block mb-8">
                        <a href="{{ route('users.create') }}" class="bg-green-500 hover:bg-green-700 text-black font-bold py-2 px-4 rounded">Novo</a>
                    </div>
                </div>
                <div class="card-body">
