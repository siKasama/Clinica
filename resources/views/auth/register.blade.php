@extends('layouts.app', ['activePage' => 'register', 'title' => 'Portal Gerencial - Plasutil'])

@section('content')
    <div class="full-page register-page section-image" data-color="blue" data-image="{{ asset('img/Fachada.jpg') }}">
        <div class="content">
            <div class="container">
