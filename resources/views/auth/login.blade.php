@extends('layouts/app', ['activePage' => 'login', 'title' => 'Portal Gerencial - Plasutil [T.I.]'])

@section('content')
    <div class="full-page section-image" data-color="white" data-image="{{ asset('img/Fachada.jpg') }}">
