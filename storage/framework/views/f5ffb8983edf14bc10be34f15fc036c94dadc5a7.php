<?php $__env->startSection('content'); ?>
    <div class="full-page section-image" data-color="white" data-image="<?php echo e(asset('img/Fachada.jpg')); ?>">
                    ...
                    <form class="form" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="card card-login card-hidden">
                            <div class="card-header">
                                <h3 class="header text-center text-info"><?php echo e(__('Login')); ?></h3>
                            </div>
                            <div class="card-body ">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="email" class="col-md-6 col-form-label"><?php echo e(__('Usuario')); ?></label>
...
<?php echo $__env->make('layouts/app', ['activePage' => 'login', 'title' => 'Portal Gerencial - Plasutil [T.I.]'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gerencia-sr\resources\views/auth/login.blade.php ENDPATH**/ ?>